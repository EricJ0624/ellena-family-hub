 ...
 *
 * Phase 4: `.widget-scale-root`(container-type:size)에서 cqmin 스케일.
 * tasks도 동일 스케일 루트를 사용(default / highend_glass = 다른 위젯과 같은 셀 높이).
 * kids 칠판은 CSS `:has(.chalkboard-frame)` 로 scale-root 높이를 auto·overflow visible로 되돌림.
