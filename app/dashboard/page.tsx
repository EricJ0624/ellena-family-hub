...
export default function FamilyHub() {
  ...
  const calendarTranslations = useMemo(() => ({
    ...
    event_edit_title: getDashboardTranslation(lang, 'event_edit_title'),
    event_update_btn: getDashboardTranslation(lang, 'event_update_btn'),
    event_start_date: getDashboardTranslation(lang, 'event_start_date'),
    event_end_date: getDashboardTranslation(lang, 'event_end_date'),
    event_end_unset: getDashboardTranslation(lang, 'event_end_unset'),
    event_single_date: getDashboardTranslation(lang, 'event_single_date'),
    event_picker_start: getDashboardTranslation(lang, 'event_picker_start'),
    event_picker_end: getDashboardTranslation(lang, 'event_picker_end'),
    event_picker_year_month: getDashboardTranslation(lang, 'event_picker_year_month'),
        ...
        return (
          <FamilyGamesSection
            ...
            translations={{
              ...
              ladder_lanes_not_ready: gt('ladder_lanes_not_ready'),
              ...
              games_create_game: gt('games_create_game'),
      ...
      >
        ...
        <header className="app-header">
          <TitlePage 
            ...
            onPhotoOrientationChange={setFrameIsPortrait}
