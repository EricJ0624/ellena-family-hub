  ...
  return (
    <div className="games-tab-panel games-tab-lobby">
      <div className="games-setup-scroll grid" style={{ gap: '2cqmin' }}>
        ...
        <div>
          <div className="mb-2 flex flex-wrap items-center justify-between" style={{ gap: '1cqmin' }}>
            <span className="font-semibold text-[#334155]" style={{ fontSize: '4.5cqmin' }}>
              {t.ladder_participants}
            </span>
            <span className="font-medium text-[#64748b]" style={{ fontSize: '3.5cqmin' }}>
          ...
          <ul className="m-0 list-none p-0" style={{ display: 'grid', gap: '1cqmin' }}>
            {participants.length === 0 ? (
              ...
              participants.map((p) => (
                ...
                >
                  <span className="font-medium text-[#1e293b]" style={{ fontSize: '4cqmin' }}>
                    {labelFor(p.user_id)}
                  </span>
          ...
          {showSlotControls && (
            <div className="mt-2 flex flex-wrap" style={{ gap: '1cqmin' }}>
              <button
                type="button"
      ...
      <div className="grid flex-shrink-0" style={{ gap: '1.5cqmin' }}>
        {isHost ? (
          <button
            type="button"
