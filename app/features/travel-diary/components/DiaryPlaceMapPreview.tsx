            ...
            >
              ...
              >
                <button
                  type="button"
                  onClick={close}
                  className="absolute right-2 top-2 z-20 inline-flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border-0 bg-black/65 text-white shadow-md backdrop-blur-sm hover:bg-black/80"
                  aria-label="닫기"
                >
                  <X className="h-4 w-4" strokeWidth={2.5} />
                </button>
                <div className="flex items-center justify-between gap-2 border-b border-slate-200 py-2 pl-3 pr-12">
