...
const td: Record<LangCode, TravelDiaryTranslations> = {
  ko: {
    ...
    receipt_need_expense: '실제 지출 금액을 넣어주세요.',
    receipt_upload_failed: '영수증 업로드에 실패했습니다.',
    ...
    photos_album_add: '추가',
    photo_focus_title: '사진 위치 맞추기',
    photo_focus_hint: '세로 사진입니다. 프레임 안에서 위아래로 끌어 얼굴이 잘 보이게 맞춰 주세요.',
    photo_focus_confirm: '적용',
    photo_focus_skip: '그냥 두기',
    map_label: '지도',
    map_add: '지도 넣기',
    map_remove: '지도 빼기',
    hide: '삭제',
  ...
  en: {
    ...
    receipt_need_expense: 'Please enter the actual expense amount.',
    ...
    photo_focus_title: 'Adjust photo crop',
    photo_focus_hint: 'Portrait photo. Drag up/down inside the frame so faces stay visible.',
    photo_focus_confirm: 'Apply',
    photo_focus_skip: 'Skip',
    map_label: 'Map',
    map_add: 'Add map',
  ...
  ja: {
    ...
    expense_label: '実際の支出',
    receipt_upload: '領収書アップロード',
    receipt_need_expense: '実際の支出金額を入力してください。',
    receipt_upload_failed: '領収書のアップロードに失敗しました。',
    ...
    photos_album_add: '追加',
    photo_focus_title: '写真の位置を合わせる',
    photo_focus_hint: '縦写真です。枠の中を上下にドラッグして顔が見えるように合わせてください。',
    photo_focus_confirm: '適用',
    photo_focus_skip: 'スキップ',
    map_label: '地図',
    map_add: '地図を入れる',
    map_remove: '地図を外す',
    hide: '削除',
  ...
  'zh-CN': {
    ...
    expense_label: '实际支出',
    receipt_upload: '上传收据',
    receipt_need_expense: '请输入实际支出金额。',
    receipt_upload_failed: '收据上传失败。',
    no_slots: '没有行程可显示。',
    upload_failed: '上传失败。',
    photos_close: '关闭',
    ...
    photos_album_add: '添加',
    photo_focus_title: '调整照片位置',
    photo_focus_hint: '竖向照片。在框内上下拖动，让脸部保持可见。',
    photo_focus_confirm: '应用',
    photo_focus_skip: '跳过',
    map_label: '地图',
    map_add: '加入地图',
    map_remove: '移除地图',
  ...
  'zh-TW': {
    ...
    expense_label: '實際支出',
    receipt_upload: '上傳收據',
    receipt_need_expense: '請輸入實際支出金額。',
    receipt_upload_failed: '收據上傳失敗。',
    no_slots: '沒有行程可顯示。',
    upload_failed: '上傳失敗。',
    photos_close: '關閉',
    ...
    photos_album_add: '新增',
    photo_focus_title: '調整照片位置',
    photo_focus_hint: '直向照片。在框內上下拖曳，讓臉部保持可見。',
    photo_focus_confirm: '套用',
    photo_focus_skip: '略過',
    map_label: '地圖',
    map_add: '加入地圖',
    map_remove: '移除地圖',
  ...
  es: {
    ...
    receipt_need_expense: 'Introduce el importe del gasto real.',
    receipt_upload_failed: 'Error al subir el recibo.',
    ...
    photo_focus_title: 'Ajustar recorte',
    photo_focus_hint: 'Foto vertical. Arrastra arriba/abajo en el marco para ver las caras.',
    photo_focus_confirm: 'Aplicar',
    photo_focus_skip: 'Omitir',
    map_label: 'Mapa',
    map_add: 'Añadir mapa',
  ...
  fr: {
    ...
    receipt_upload: 'Téléverser un reçu',
    receipt_need_expense: 'Saisissez le montant de la dépense réelle.',
    receipt_upload_failed: 'Échec du téléversement du reçu.',
    ...
    photo_focus_title: 'Ajuster le cadrage',
    photo_focus_hint: 'Photo portrait. Faites glisser dans le cadre pour garder les visages visibles.',
    photo_focus_confirm: 'Appliquer',
    photo_focus_skip: 'Passer',
    map_label: 'Carte',
  ...
  de: {
    ...
    receipt_upload: 'Beleg hochladen',
    receipt_need_expense: 'Bitte den Betrag der tatsächlichen Ausgaben eingeben.',
    ...
    photo_focus_title: 'Ausschnitt anpassen',
    photo_focus_hint: 'Hochformat. Ziehen Sie im Rahmen, damit Gesichter sichtbar bleiben.',
    photo_focus_confirm: 'Übernehmen',
    photo_focus_skip: 'Überspringen',
    map_label: 'Karte',
  ...
  it: {
    ...
    receipt_upload: 'Carica ricevuta',
    receipt_need_expense: 'Inserisci l’importo della spesa effettiva.',
    receipt_upload_failed: 'Caricamento ricevuta non riuscito.',
    ...
    photo_focus_title: 'Regola il ritaglio',
    photo_focus_hint: 'Foto verticale. Trascina nel riquadro per tenere i volti visibili.',
    photo_focus_confirm: 'Applica',
    photo_focus_skip: 'Salta',
    map_label: 'Mappa',
  ...
  pt: {
    ...
    expense_label: 'Gasto real',
    receipt_upload: 'Enviar recibo',
    receipt_need_expense: 'Insira o valor do gasto real.',
    receipt_upload_failed: 'Falha ao enviar o recibo.',
    ...
    photo_focus_title: 'Ajustar recorte',
    photo_focus_hint: 'Foto vertical. Arraste no quadro para manter os rostos visíveis.',
    photo_focus_confirm: 'Aplicar',
    photo_focus_skip: 'Ignorar',
    map_label: 'Mapa',
