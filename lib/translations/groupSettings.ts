...
const groupSettings: Record<LangCode, GroupSettingsTranslations> = {
  ...
  pt: {
    ...
    theme_stable_glass_label: 'Vidro estável',
    theme_stable_glass_desc: 'Estilo visual atual, seguro para produção.',
    theme_highend_glass_label: 'Vidro premium',
    theme_highend_glass_desc: 'Desfoque, destaque e contraste aprimorados para uma sensação premium.',
