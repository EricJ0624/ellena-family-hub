...
const resetPassword: Record<LangCode, ResetPasswordTranslations> = {
  ...
  es: {
    ...
    success_reset: '¡La contraseña se ha actualizado correctamente!',
    error_reset_failed: 'No se pudo actualizar la contraseña. Inténtalo de nuevo.',
  },
  fr: {
    ...
    success_reset: 'Le mot de passe a été mis à jour avec succès !',
    error_reset_failed: 'Échec de la mise à jour du mot de passe. Veuillez réessayer.',
  },
  de: {
    title: 'Passwort zurücksetzen',
    subtitle: 'Geben Sie Ihr neues Passwort ein',
    placeholder_new_password: 'Neues Passwort',
    placeholder_confirm: 'Passwort bestätigen',
    btn_loading: 'Wird aktualisiert...',
    btn_submit: 'Passwort aktualisieren',
    success_reset: 'Passwort wurde erfolgreich aktualisiert!',
    error_reset_failed: 'Passwort konnte nicht aktualisiert werden. Bitte erneut versuchen.',
  },
  it: {
    title: 'Reimposta password',
    subtitle: 'Inserisci la nuova password',
    placeholder_new_password: 'Nuova password',
    placeholder_confirm: 'Conferma password',
    btn_loading: 'Aggiornamento...',
    btn_submit: 'Aggiorna password',
