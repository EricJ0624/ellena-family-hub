...
const groupAdmin: Record<LangCode, GroupAdminTranslations> = {
  ko: {
    ...
    widgets_size_hint: '폰 가로·PC 가로 미리보기·넓은 PC 화면에서 L/XL이 넓게 배치됩니다. 세로·좁은 화면은 1열로 줄어듭니다.',
    widgets_size_S: 'S (작게)',
    widgets_size_M: 'M (기본)',
    widgets_size_L: 'L (넓게)',
  ...
  en: {
    ...
    widgets_size_hint: 'L/XL use a wider grid on phone landscape, PC landscape preview, and wide PC layouts. Portrait and narrow widths stay single-column.',
  ...
  ja: {
    ...
    widgets_size_hint: 'スマホ横・PC横プレビュー・広いPC画面ではL/XLが広く並びます。縦・狭い画面は1列になります。',
    widgets_size_S: 'S（小）',
    widgets_size_M: 'M（標準）',
    widgets_size_L: 'L（広め）',
  ...
  'zh-CN': {
    ...
    widgets_size_hint: '手机横屏、PC 横屏预览与宽屏 PC 上 L/XL 会加宽排列；竖屏与窄屏仍为单列。',
    widgets_size_S: 'S（紧凑）',
    widgets_size_M: 'M（默认）',
    widgets_size_L: 'L（宽）',
  ...
  'zh-TW': {
    ...
    widgets_size_hint: '手機橫向、PC 橫向預覽與寬螢幕 PC 上 L/XL 會加寬排列；直向與窄螢幕仍為單欄。',
    widgets_size_S: 'S（緊湊）',
    widgets_size_M: 'M（預設）',
    widgets_size_L: 'L（較寬）',
