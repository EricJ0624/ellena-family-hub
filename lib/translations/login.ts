...
const login: Record<LangCode, LoginTranslations> = {
  ...
  pt: {
    ...
    tab_login: 'Entrar',
    tab_signup: 'Cadastrar-se',
    tab_forgot: 'Esqueci a senha',
    keep_logged_in: 'Manter-me conectado',
    placeholder_nickname: 'Apelido (obrigatório, 2–20 caracteres)',
    placeholder_email: 'Endereço de e-mail',
    placeholder_password: 'Senha',
    placeholder_confirm_password: 'Confirmar senha',
    btn_loading_login: 'Entrando...',
    btn_loading_signup: 'Cadastrando...',
    btn_loading_send: 'Enviando...',
    btn_submit_login: 'Entrar',
    btn_submit_signup: 'Cadastrar-se',
    btn_submit_reset: 'Enviar link de redefinição',
    ...
    error_nickname_length: 'O apelido deve ter entre 2 e 20 caracteres.',
    label_display_language: 'Idioma de exibição (obrigatório)',
    label_country_residence: 'País de residência (obrigatório)',
    country_select_placeholder: 'Selecione seu país',
    country_residence_help:
      'Selecione o país onde você mora atualmente. Usamos isso para personalizar o app e estatísticas agregadas do serviço. Você pode alterar depois nas configurações da conta.',
