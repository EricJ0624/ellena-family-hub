...
const games: Record<LangCode, GamesTranslations> = {
  ko: {
    ...
    ladder_result_announce: '결과 발표!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: '축하해요!',
    games_congrats_dismiss: '확인',
  ...
  en: {
    ...
    ladder_result_announce: 'Results are in!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'Congratulations!',
    games_congrats_dismiss: 'OK',
  ...
  ja: {
    ...
    ladder_result_announce: '結果発表！',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'おめでとう！',
    games_congrats_dismiss: 'OK',
  ...
  'zh-CN': {
    ...
    ladder_result_announce: '结果公布！',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: '恭喜！',
    games_congrats_dismiss: '确定',
  ...
  'zh-TW': {
    ...
    ladder_reset: '重新開始',
    ladder_result_title: '結果',
    ladder_result_announce: '結果公布！',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: '恭喜！',
    games_congrats_dismiss: '確定',
  ...
  es: {
    ...
    ladder_result_announce: '¡Resultados listos!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: '¡Felicidades!',
    games_congrats_dismiss: 'OK',
  ...
  fr: {
    ...
    ladder_result_announce: 'Résultats prêts !',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'Félicitations !',
    games_congrats_dismiss: 'OK',
  ...
  de: {
    ...
    ladder_result_announce: 'Ergebnisse sind da!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'Glückwunsch!',
    games_congrats_dismiss: 'OK',
  ...
  it: {
    ...
    ladder_result_announce: 'Risultati pronti!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'Congratulazioni!',
    games_congrats_dismiss: 'OK',
  ...
  pt: {
    ...
    ladder_reset: 'Reiniciar',
    ladder_result_title: 'Resultados',
    ladder_result_announce: 'Resultados prontos!',
    ladder_path_result: '{from} → {to}',
    games_congrats_title: 'Parabéns!',
    games_congrats_dismiss: 'OK',
